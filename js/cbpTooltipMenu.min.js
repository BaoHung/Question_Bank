 ...
 */
(function (d) {
    var c = d.document, b = c.documentElement;
    function h(j, i) {
        for (var k in i) {
    ...
    function a() {
        var i = b.clientHeight, j = d.innerHeight;
        if (i < j) {
            return j
        } else {
            return i
    ...
    g.prototype = {defaults: {delayMenu: 100}, _init: function () {
            ...
            this.omtimeout = setTimeout(function () {
                var k = j.querySelector("ul.cbp-tm-submenu");
                if (k) {
            ...
            clearTimeout(this.omtimeout);
            var i = j.querySelector("ul.cbp-tm-submenu");
            if (i) {
            ...
            var m = l.parentNode, i = Array.prototype.slice.call(this.menuItems), k = m.querySelector("ul.cbp-tm-submenu");
            ...
            var m = a(), k = f(j), i = k.top, l = m - i - j.offsetHeight;
